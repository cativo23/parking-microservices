...
abstract class BaseAPIController extends Controller
{
     ...
     */
    protected function errorNotFound(string $message = 'Resource Not Found', string $description = ''): JsonResponse
    {
     ...
     */
    protected function errorWrongData(
        string $message = 'Bad Data Sent',
        string $description = 'Data is wrong!'
    ): JsonResponse
    {
